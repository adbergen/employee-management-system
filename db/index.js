    ...
    .prompt([
      {
        ...
        type: "list",
        message:
          "What department will this role be in? Select 1-Engineering, 2-Sales, 3-HR, 4-IT, 5-Legal",
        choices: [1, 2, 3, 4, 5],
      },
      {
        name: "title",
  ...
  inquirer
    .prompt([
      ...
      },
      {
        ...
        type: "list",
        message:
          "What department will they belong to? SELECT 1 for Sales, 2 for Engineering, 3 for Finance, 4 for Legal.",
        choices: [1, 2, 3, 4],
      },
    ])
    .then(function (answer) {
